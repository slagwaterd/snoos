...
2. Follow the "STRICT LINGUISTIC RULES" and "STRUCTURE OBLIGATION" from the agent definition ABOVE.
3. If the definition says NO greetings/signatures, do NOT include them.
4. Keep the tone professional but high-impact.
5. If the language is NL (Dutch), respond in Dutch.
6. Provide ONLY a JSON object with "subject" and "content" fields. Use <br/> for line breaks in "content".
